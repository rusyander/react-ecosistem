...
import cls from './CoreAuditFormsWidgets.module.scss';
import {
  CheckFormEnterM,
  Grid,
  classNames,
...
export interface CoreAuditFormsWidgetsProps {
  className?: string;
}
...
export const CoreAuditFormsWidgets = memo(
  (props: CoreAuditFormsWidgetsProps) => {
    ...
    const roleName = 'CORE_AUDIT_FORMS';
    ...
    return (
      <div className={classNames(cls.coreAuditFormsWidgets, {}, [className])}>
