...
import cls from './CoreAuditActionsWidgets.module.scss';
import {
  CheckFormEnterM,
  Grid,
  classNames,
...
export interface CoreAuditActionsWidgetsProps {
  className?: string;
}
...
export const CoreAuditActionsWidgets = memo(
  (props: CoreAuditActionsWidgetsProps) => {
    ...
    const roleName = 'CORE_AUDIT_ACTIONS';
      ...
      async (currentPage?: number, pageSizeElement?: number) => {
        ...
        if (grid?.result === '1') {
          if (grid?.data?.totalElements) {
            ...
            setPageLimit(pageSizeElement ?? 0);
    ...
    return (
      <div className={classNames(cls.coreAuditActionsWidgets, {}, [className])}>
        ...
        {headerData && (
          <Grid
            ...
            AddNewButtonComponents={
              [
                // <CoreAuditSessionsFeatures selectedField={selected} key={1} />,
