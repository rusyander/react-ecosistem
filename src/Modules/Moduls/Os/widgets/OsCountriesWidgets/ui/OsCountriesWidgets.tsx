...
import cls from './OsCountriesWidgets.module.scss';
import {
  CheckFormEnterM,
  Grid,
  GridSkeleton,
...
import {
  OsCountriesFeaturesAdd,
  OsCountriesFeaturesEdit,
  OsCountriesFeaturesDelete,
} from 'Modules/Moduls/Os/features/OsCountriesFeatures';

export interface OsCountriesWidgetsProps {
  className?: string;
}

export const OsCountriesWidgets = memo((props: OsCountriesWidgetsProps) => {
  ...
  return (
    <div className={classNames(cls.osCountriesWidgets, {}, [className])}>
