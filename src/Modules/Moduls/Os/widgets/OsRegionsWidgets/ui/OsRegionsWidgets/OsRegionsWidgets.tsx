...
import cls from './OsRegionsWidgets.module.scss';
import {
  CheckFormEnterM,
  Grid,
  classNames,
...
import {
  ...
  OsRegionsEdit,
  OsRegionsDelete,
} from 'Modules/Moduls/Os/features/OsRegionsFeatures';

export interface OsRegionsWidgetsProps {
  className?: string;
}
...
export const OsRegionsWidgets = memo((props: OsRegionsWidgetsProps) => {
  ...
  return (
    <div className={classNames(cls.osRegionsWidgets, {}, [className])}>
      ...
      {headerData && (
        <Grid
          ...
          AddNewButtonComponents={[
            <OsRegionsAdd key={1} />,
            <OsRegionsEdit key={2} selectedField={selected} />,
            <OsRegionsDelete key={3} selectedField={selected} />,
          ]}
          // loading
          isLoading={isLoading}
          // optional components
